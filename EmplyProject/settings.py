"""
Django settings for EmplyProject project.
...
ROOT_URLCONF = 'EmplyProject.urls'
...
WSGI_APPLICATION = 'EmplyProject.wsgi.application'
...
MEDIAFILES_DIRS = [
    os.path.join(BASE_DIR, "media_in_pro"),
]
